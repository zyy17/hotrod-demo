...
CREATE TABLE IF NOT EXISTS `__otel_traces_services_red_metrics_1m` (
...
CREATE FLOW IF NOT EXISTS `__otel_traces_services_red_metrics_1m_aggregation`
...
CREATE FLOW IF NOT EXISTS `__otel_traces_services_red_metrics_1h_aggregation`
...
CREATE FLOW IF NOT EXISTS `__otel_traces_spans_red_metrics_1m_aggregation`
...
CREATE FLOW IF NOT EXISTS `__otel_traces_spans_red_metrics_1h_aggregation`
...
CREATE FLOW IF NOT EXISTS `__otel_traces_dependencies_1h_aggregation`
